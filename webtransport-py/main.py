...
if __name__ == '__main__':
    ...
    event_loop.create_task(run_server_websockets(BIND_ADDRESS, 5001, args.certificate, args.key))
    event_loop.create_task(run_game_server_connector('127.0.0.1', 5002))
