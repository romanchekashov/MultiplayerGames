...
M.CPU_USAGE = {
	...
	ABOUT_4_BUT_IN_DOCKER_15_PERCENT = M.TIMES._50_MILISECONDS, -- update called ? times in Ubuntu 22.04.4 LTS(amd64)
	ABOUT_5_BUT_IN_DOCKER_20_PERCENT = M.TIMES._30_MILISECONDS, -- update called 28 times in Ubuntu 22.04.4 LTS(amd64)
